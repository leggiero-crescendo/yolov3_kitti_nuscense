...
def make_rount_layer(layer_idx : int, modules : nn.Module):
...
class Darknet53(nn.Module):
    ...
    class Yololayer(nn.Module):
        ...
        def forward(self, x):
            ...
            # if kitti data. n_classes is 8. C=(8+5)*3 = 39  [convolutional]filters=39
            #[batch, box_attrib * anchor, lw, lh]  ex)[1,39,19,19]
            #4dim [batch, box_attrib * anchor, lw, lh] => 5dim [batch, anchor, box_attrib, lw, lh]
    ...
    def set_layer(self, layer_info):
        ...
        for layer_idx, info in enumerate(layer_info):
            ...
            if info['type'] == 'convolutional':
                ...
                make_rount_layer(layer_idx, modules)
